...
const AboutCoverSection = () => {
    return (
        <section className='w-full md:h-[66vh] flex flex-col flex-wrap md:flex-row items-center justify-center text-dark dark:text-light'>
            ...
            <div className='w-full mt-5 md:w-1/2 flex flex-col text-left items-start justify-center px-5 xs:p-10 pb-10 lg:px-16'>
